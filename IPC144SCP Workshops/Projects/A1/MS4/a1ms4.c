...
int main(void)
{
	...
	printf("Name Details\n");
	printf("------------\n");
	printf("First name: %s\n", contact[1].name.firstName);
	printf("Middle initial(s): %s\n", contact[1].name.middleInitial);
	printf("Last name: %s\n", contact[1].name.lastName);
	printf("\nAddress Details\n");
	printf("---------------\n");
	printf("Street number: %d\n", contact[1].address.streetNumber);
	printf("Street name: %s\n", contact[1].address.street);
	printf("Apartment: %d\n", contact[1].address.apartmentNumber);
	printf("Postal code: %s\n", contact[1].address.postalCode);
	printf("City: %s\n", contact[1].address.city);
	printf("\nPhone Numbers\n");
	printf("-------------\n");
	printf("Cell phone number: %s\n", contact[1].numbers.cell);
	printf("Home phone number: %s\n", contact[1].numbers.home);
	printf("Business phone number: %s\n", contact[1].numbers.business);
